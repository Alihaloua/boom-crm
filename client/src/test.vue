					...
					<div class="space-y-6">
						<div class="space-y-4">
							...
							<div class="flex items-center space-x-6">
								...
								<label
									class="flex items-center mt-6 space-x-1.5"
								>
									<input
										type="checkbox"
							...
							>
								...
								>
									<fieldset class="space-y-2">
										...
										>
											Select how this flow should be
											shown.
										</legend>
									...
									>
										...
										<div
											class="px-6 py-5 rounded-md bg-gray-100"
										>
											<p
												class="text-sm leading-5 text-center text-gray-600"
											>
												This flow will be shown only on
												the specific page or pages you
												provide.
											</p>
										</div>
									</fieldset>
